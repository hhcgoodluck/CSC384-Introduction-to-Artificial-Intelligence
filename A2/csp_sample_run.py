...
btracker = BacktrackingSearch(simpleCSP)
btracker.enable_trace()

print("Plain Bactracking on simple CSP")
btracker.search(prop_BT)
print("=======================================================")
print("Forward Checking on simple CSP")
btracker.search(prop_FC)
print("=======================================================")
print("GAC on simple CSP")
btracker.search(prop_GAC)
...
def solve_nQueens(n, propType, trace=False):
    ...
    if trace:
        solver.enable_trace()
    if propType == 'BT':
        solver.search(prop_BT)
    elif propType == 'FC':
        solver.search(prop_FC)
    elif propType == 'GAC':
        solver.search(prop_GAC)
